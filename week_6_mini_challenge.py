...
my_list = ["My name is Jesse", 1, True, "Cesar", 19]
print(my_list)
# Lists Practice #2
...
my_dic = {"name":"Karen","surname":"Jurgens","age":"35","occupation":"Journalist"}
print(my_dic)
...
print(my_dict.get("points"))
 #Use dictionary indixes to extract the second item of points2

# print(my_dict.get("points2"[2]))
...
my_dict1 = {"name":"Karen", "surname":"Jurgens", "age":35, "occupation":"Journalist"}
my_dict1.update({"country": "Colombia"})
print(my_dict1)
